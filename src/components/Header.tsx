        ...
        <div className="flex items-center gap-3">
          <div className="hidden xl:flex items-center gap-4 bg-[#1E293B] border border-[#334155] px-3 py-1.5 rounded text-xs font-mono">
            ...
            <div className="flex items-center gap-1.5">
              <span
                title="Verified via live audit as of September 13, 2026 — this project has previously had gateway hardening regress silently between sessions; status reflects the most recent live check, not a one-time claim."
